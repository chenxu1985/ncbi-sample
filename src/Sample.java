...
public class Sample {
    ...
    public static void main(String[] args) {
        ...
        //需要解析的索引文件
        String sampleFilePath = "/Users/laphael/Desktop/ncbi/sampleTest.xml";
        String outPath = "/Users/laphael/Desktop/ncbi/sampleTest.sql";
...
//                System.out.println(accession+":"+organization);
                ...
                if(attribute.equals("{}")){
                    insertSampleSql = "insert into sample(second_accession,second_accession_hash,user_id,name,taxon_id,title,public_description,release_time,create_time,status,release_state,submission_status,release_flag,create_flag,keyword,package,model,owner_name,owner_abbreviation,contact_email) " +
                            " values('"+accession+"','"+accession+"',2930,";
                } else {
                    insertSampleSql = "insert into sample(second_accession,second_accession_hash,attributes,user_id,name,taxon_id,title,public_description,release_time,create_time,status,release_state,submission_status,release_flag,create_flag,keyword,package,model,owner_name,owner_abbreviation,contact_email) " +
                            " values('"+accession+"','"+accession+"','"+attribute+"',2930,";
                }
                if(name.contains("\"")){
                    if(name.contains("'")){
                        name = name.replace("'","\\'");
